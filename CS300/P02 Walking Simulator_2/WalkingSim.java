...
public class WalkingSim {
    ...
    public static void mousePressed () {
        boolean setWalking = false;
        int i = 0;
        System.out.println("mousepressed");
        while (!setWalking && i < walkers.length) {
            System.out.println(setWalking + " " + i);
            if (walkers[i] != null && !walkers[i].isWalking()) {
                ...
                if (Utility.mouseX() < rightBound && Utility.mouseX() > leftBound && 
                    ...
                    System.out.println("mouseXY " + Utility.mouseX() + " " + Utility.mouseY());
                    System.out.println("bounds " + leftBound + " " + topBound + " " + rightBound + " " + bottomBound);        
                    System.out.println("in if " + i);
                    walkers[i].setWalking(true);
                    System.out.println(walkers[i].isWalking() + " " + i);
                    setWalking = true;
                } 
            }
            i++;
